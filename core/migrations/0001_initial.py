    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrateur'), ('CENTRAL_MGR', 'Manager Stock Central'), ('BRANCH_MGR', 'Manager Agence'), ('TECH', 'Technicien'), ('ACCOUNTANT', 'Comptable'), ('AUDITOR', 'Auditeur'), ('PARTNER', 'Partenaire'), ('USER', 'Par defaut')], default='USER', max_length=30)),
